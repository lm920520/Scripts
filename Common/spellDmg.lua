...
function getDmg(spellname,target,owner,stagedmg,spelllvl)
	...
	elseif spellname == "Q" or spellname == "W" or spellname == "E" or spellname == "R" or spellname == "P" or spellname == "QM" or spellname == "WM" or spellname == "EM" then
		...
		elseif name == "Braum" then
			if spellname == "P" then DmgM = math.max((10*lvl+60)*(stagedmg1+stagedmg3),(2*lvl+12)*stagedmg2) --stage1-stage3:Stun. stage2:bonus damage.
		...
		elseif name == "Kayle" then
			...
			elseif spellname == "E" then DmgM = 10*Elvl+10+.4*ap TypeDmg = 2 --xhit (bonus)
			end
		...
		elseif name == "Maokai" then
			...
			elseif spellname == "W" then DmgM = 35*Wlvl+45+.8*ap
			elseif spellname == "E" then DmgM = math.max((35*Elvl+5+.4*ap)*stagedmg1,(50*Elvl+30+.6*ap)*stagedmg2,(85*Elvl+35+ap)*stagedmg3) --stage1:Impact. stage2:Explosion. stage3: Max damage
		...
		elseif name == "Nidalee" then
			...
			elseif spellname == "W" then DmgM = 20*Wlvl+(2*Wlvl+10+.02*ap)*thp/100 -- over 4 sec
		...
		elseif name == "Skarner" then
			...
			elseif spellname == "Q" then DmgP = (12*Qlvl+8+.4*bad)*(stagedmg1+stagedmg3) QDmgM = (12*Qlvl+8+.2*ap)*(stagedmg2+stagedmg3) --stage1:basic. stage2: charge bonus. stage2: total
		...
		elseif name == "Yasuo" then
			...
			elseif spellname == "E" then DmgM = 20*Elvl+50+.6*ap --Each cast increases the next dash's base damage by 25%, up to 100% bonus damage
