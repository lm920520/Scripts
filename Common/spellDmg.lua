...
spellDmg = {
	...
	Rengar = {
		PType = 2,
		QDmgP = "math.max((30*Qlvl+(.05*Qlvl-.05)*ad)*stagedmg1,(math.min(15*lvl+15,10*lvl+60)+.5*ad)*(stagedmg2+stagedmg3))", --stage1:Savagery. stage2-stage3:Empowered Savagery.
		QType = 2,
	...
	Rumble = {
		...
		PType = 2,
		QDmgM = "math.max(20*Qlvl+5+.33*ap,(20*Qlvl+5+.33*ap)*3*stagedmg3)", --xsec (3 sec) , with 50 heat deals 150% damage. stage3: Max damage , with 50 heat deals 150% damage
		EDmgM = "25*Elvl+20+.4*ap", --xshoot (2 shoots) , with 50 heat deals 150% damage
