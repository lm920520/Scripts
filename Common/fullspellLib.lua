spellList = {
    ...
    Headbutt = {charName = "Alistar", spellSlot = "W", range = 650, width = 0 , speed = 0, delay = .5, spellType = "enemyCast", riskLevel = "extreme", cc = true, hitLineCheck = true},
	...
	-- Braum
	BraumQ = {charName = "Braum", spellSlot = "Q", range = 1100, width = 100, speed = 1200, delay = .5, spellType = "skillShot", riskLevel = "extremeq", cc = true, hitLineCheck = true},
	BraumQMissle = {charName = "Braum", spellSlot = "Q", range = 1100, width = 100, speed = 1200, delay = .5, spellType = "skillShot", riskLevel = "extremeq", cc = true, hitLineCheck = true},
	BraumW = {charName = "Braum", spellSlot = "W", range = 650, width = 0, speed = 1500, delay = .5, spellType = "allyCast", riskLevel = "noDmgr", cc = false,  hitLineCheck = false},
	...
	-- Caitlyn
	CaitlynPiltoverPeacemaker = {charName = "Caitlyn", spellSlot = "Q", range = 2000, width = 90, speed = 2200, delay = .25, spellType = "skillShot", riskLevel = "kill", cc = false, hitLineCheck = true},
	...
	-- DrMundo
	InfectedCleaverMissileCast = {charName = "DrMundo", spellSlot = "Q", range = 1000, width = 75, speed = 1500, delay = .5, spellType = "skillShot", riskLevel = "extreme", cc = true, hitLineCheck = true},
	...
	EliseSpiderQCast = {charName = "Elise", spellSlot = "QM", range = 475, width = 0, speed = math.huge, delay = .5, spellType = "enemyCast", riskLevel = "kill", cc = false, hitLineCheck = false},
	EliseSpiderW = {charName = "Elise", spellSlot = "WM", range = 0, width = 0, speed = math.huge, delay = math.huge, spellType = "selfCast", riskLevel = "noDmg", cc = false, hitLineCheck = false},
	EliseSpiderEInitial = {charName = "Elise", spellSlot = "EM", range = 975, width = 0, speed = math.huge, delay = math.huge, spellType = "enemyCast", riskLevel = "noDmg", cc = false, hitLineCheck = false},
	elisespideredescent = {charName = "Elise", spellSlot = "EM", range = 975, width = 0, speed = math.huge, delay = math.huge, spellType = "enemyCast", riskLevel = "noDmg", cc = false, hitLineCheck = false},
	...
	-- Gragas
	GragasQ = {charName = "Gragas", spellSlot = "Q", range = 1100 , width = 320 , speed = 1000, delay = .3, spellType = "skillShot", riskLevel = "kill", cc = false, hitLineCheck = false},
	gragasQToggle = {charName = "Gragas", spellSlot = "Q", range = 1100 , width = 320 , speed = 1000, delay = .3, spellType = "skillShot", riskLevel = "kill", cc = false, hitLineCheck = false},
	GragasW = {charName = "Gragas", spellSlot = "W", range = 0 , width = 0 , speed = 0, delay = 0, spellType = "selfCast", riskLevel = "noDmg", cc = false, hitLineCheck = false},
	GragasE = {charName = "Gragas", spellSlot = "E", range = 1100 , width = 50 , speed = 1000, delay = .3, spellType = "skillShot", riskLevel = "extreme", cc = true, hitLineCheck = true},
	GragasR = {charName = "Gragas", spellSlot = "R", range = 1100 , width = 700 , speed = 1000, delay = .3, spellType = "skillShot", riskLevel = "extreme", cc = true, hitLineCheck = false},
	-- Graves
	...
	jayceshockblast = {charName = "Jayce", spellSlot = "QM", range = 1050 , width = 80 , speed = 1200, delay = .5, spellType = "skillShot", riskLevel = "kill", cc = false, hitLineCheck = false},
	jaycehypercharge = {charName = "Jayce", spellSlot = "WM", range = 0 , width = 0 , speed = math.huge, delay = .75, spellType = "selfCast", riskLevel = "noDmg", cc = false, hitLineCheck = false},
	jayceaccelerationgate = {charName = "Jayce", spellSlot = "EM", range = 685 , width = 0 , speed = 1600, delay = .5, spellType = "skillShot", riskLevel = "noDmg", cc = false, hitLineCheck = false},
	...
	-- Jinx
	JinxQ = {charName = "Jinx", spellSlot = "Q", range = 0, width = 0, speed = math.huge, delay = 0, spellType = "selfcast", riskLevel = "noDmg", cc = false, hitLineCheck = false},
	JinxW = {charName = "Jinx", spellSlot = "W", range = 1550 , width = 70, speed = 1200, delay = .5, spellType = "skillShot", riskLevel = "dangerous", cc = true, hitLineCheck = true},
	JinxWMissle = {charName = "Jinx", spellSlot = "W", range = 1550 , width = 70 , speed = 1200, delay = .5, spellType = "skillShot", riskLevel = "extreme", cc = true, hitLineCheck = true},
	JinxE = {charName = "Jinx", spellSlot = "E", range = 900 , width = 550 , speed = 1000, delay = .5, spellType = "skillShot", riskLevel = "extreme", cc = true, hitLineCheck = false},
	JinxR = {charName = "Jinx", spellSlot = "R", range = 25000 , width = 120, speed = math.huge, delay = 0, spellType = "skillshot", riskLevel = "kill", cc = false, hitLineCheck = true},
	JinxRWrapper = {charName = "Jinx", spellSlot = "R", range = 25000 , width = 120, speed = math.huge, delay = 0, spellType = "skillshot", riskLevel = "kill", cc = false, hitLineCheck = true},
	-- Karthus
	...
	-- Kennen
	KennenShurikenHurlMissile1 = {charName = "Kennen", spellSlot = "Q", range = 1000, width = 50, speed = 1700, delay = .69, spellType = "skillShot", riskLevel = "kill", cc = false, hitLineCheck = true},
    ...
    LeonaZenithBlade = {charName = "Leona", spellSlot = "E", range = 900, width = 100, speed = 2000, delay = 0, spellType = "skillShot", riskLevel = "extreme" , cc = true, hitLineCheck = true},
    LeonaZenithBladeMissle = {charName = "Leona", spellSlot = "E", range = 900, width = 100, speed = 2000, delay = 0, spellType = "skillShot", riskLevel = "extreme" , cc = true, hitLineCheck = true},
	...
	LuxPrismaticWave = {charName = "Lux", spellSlot = "W", range = 1075, width = 150, speed = 1200, delay = .5, spellType = "skillShot", riskLevel = "noDmg", cc = false, hitLineCheck = false, shieldSlot = _W},
	...
	-- Morgana
    DarkBindingMissile = {charName = "Morgana", spellSlot = "Q", range = 1300, width = 110, speed = 1200, delay = .5, spellType = "skillShot", riskLevel = "extreme", cc = true, hitLineCheck = true},
    ...
    AspectOfTheCougar = {charName = "Nidalee", spellSlot = "R", range = 0, width = 0, speed = math.huge, delay = 0, spellType = "selfCast", riskLevel = "noDmg", cc = false, hitLineCheck = false},
        ---Nidalee COUGAR
    Takedown = {charName = "Nidalee", spellSlot = "QM", range = 50, width = 0, speed = 500, delay = 0, spellType = "selfCast", riskLevel = "noDmg", cc = false, hitLineCheck = false},
    Pounce = {charName = "Nidalee", spellSlot = "WM", range = 375, width = 150, speed = 1500, delay = .5, spellType = "skillShot", riskLevel = "kill", cc = false, hitLineCheck = false},
    Swipe = {charName = "Nidalee", spellSlot = "EM", range = 300, width = 300, speed = math.huge, delay = .5, spellType = "skillShot", riskLevel = "kill", cc = false, hitLineCheck = false},
	-- Nocturne
	...
	--Pantehon
    PantheonQ = {charName = "Pantheon", spellSlot = "Q", range = 600, width = 0, speed = 1500, delay = .5, spellType = "enemyCast", riskLevel = "kill", cc = false, hitLineCheck = false},
    PantheonW = {charName = "Pantheon", spellSlot = "W", range = 600, width = 0, speed = math.huge, delay = .5, spellType = "enemyCast", riskLevel = "extreme", cc = true, hitLineCheck = false},
    PantheonE = {charName = "Pantheon", spellSlot = "E", range = 600, width = 100, speed = 775, delay = .5, spellType = "skillShot", riskLevel = "kill", cc = false, hitLineCheck = true},
    PantheonRJump = {charName = "Pantheon", spellSlot = "R", range = 5500, width = 1000, speed = 3000, delay = 1.0, spellType = "skillShot", riskLevel = "extreme", cc = true, hitLineCheck = false},
    PantheonRFall = {charName = "Pantheon", spellSlot = "R", range = 5500, width = 1000, speed = 3000, delay = 1.0, spellType = "skillShot", riskLevel = "extreme", cc = true, hitLineCheck = false},
	--Poppy
    ...
    ShenStandUnited = {charName = "Shen", spellSlot = "R", range = 25000, width = 0, speed = math.huge, delay = .5, spellType = "allyCast", riskLevel = "noDmg", cc = false, hitLineCheck = false, ultSlot = _R},
		-- Shyvana
	...
	-- Sivir
	SivirQ = {charName = "Sivir", spellSlot = "Q", range = 1165, width = 90, speed = 1350, delay = .5, spellType = "skillshot", riskLevel = "kill", cc = false, hitLineCheck = true},
    SivirW = {charName = "Sivir", spellSlot = "W", range = 565, width = 0, speed = math.huge, delay = .5, spellType = "enemyCast", riskLevel = "kill", cc = false, hitLineCheck = false},
    ...
    InfuseWrapper = {charName = "Soraka", spellSlot = "E", range = 725, width = 0, speed = math.huge, delay = .5, spellType = "everyCast", riskLevel = "dangerous", cc = false, hitLineCheck = false, claritySlot = _E},
    Wish = {charName = "Soraka", spellSlot = "R", range = 25000, width = 0, speed = math.huge, delay = .5, spellType = "selfCast", riskLevel = "noDmg", cc = false, hitLineCheck = false, ultSlot = _R},
	-- Swain
	...
	--Thresh
	ThreshQ = {charName = "Thresh", spellSlot = "Q", range = 1175, width = 60, speed = 1200, delay = 0.5, spellType = "skillShot", riskLevel = "extreme", cc = true, hitLineCheck = true},
	...
	BloodScent = {charName = "Warwick", spellSlot = "E", range = 1500, width = 0, speed = math.huge, delay = 0, spellType = "selfCast", riskLevel = "kill", cc = false, hitLineCheck = false},
    ...
    YorickReviveAlly = {charName = "Yorick", spellSlot = "R", range = 900, width = 0, speed = 1500, delay = .5, spellType = "allyCast", riskLevel = "noDmg", cc = false, hitLineCheck = false, ultSlot = _R},
	--Zac
	...
	zedult = {charName = "Zed", spellSlot = "R", range = 850, width = 0, speed = 0, delay = .5, spellType = "enemyCast", riskLevel = "kill", cc = false, hitLineCheck = false, timer = 2600},
	-- Ziggs
