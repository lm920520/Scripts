...
do
	...
	mages = {"Ahri","Anivia","Annie","Brand","Cassiopeia","Galio","Gragas","Heimerdinger","Janna","Karma","Karthus","LeBlanc","Lissandra","Lulu","Lux","Malzahar","Morgana","Nami","Nunu","Orianna","Ryze","Sona","Soraka","Swain","Syndra","Taric","TwistedFate","Veigar","Viktor","Xerath","Ziggs","Zilian","Zyra"}
	hybrids = {"Kayle","Teemo"}
	...
	if heroType ~= 10 then
		PrintChat("Hero Items Loaded")
	end
	if heroType == 1 then
		PrintChat("Hero Type: ADC" )
	elseif heroType == 2 then
		PrintChat("Hero Type: ADTANK" )
	elseif heroType == 3 then
		PrintChat("Hero Type: APTANK" )
	elseif heroType == 4 then
		PrintChat("Hero Type: HYBRID" )	
	elseif heroType == 5 then
		PrintChat("Hero Type: BRUISER" )	
	elseif heroType == 6 then
		PrintChat("Hero Type: ASSASSIN" )	
	elseif heroType == 7 then
		PrintChat("Hero Type: MAGE" )	
	elseif heroType == 8 then
		PrintChat("Hero Type: APC" )	
	elseif heroType == 9 then
		PrintChat("Hero Type: FIGHTER" )	
	else
		PrintChat("Hero Type: I don't know :(" )
	end
