...
DLib:RegisterDamageSource(_W, _MAGIC, 25, 45, _MAGIC, _AP, 0.8, function() return (player:CanUseSpell(_W) == READY) end)
DLib:RegisterDamageSource(_E, _MAGIC, 70, 40, _MAGIC, _AP, 1.0, function() return (player:CanUseSpell(_E) == READY) end)
DLib:RegisterDamageSource(_R, _MAGIC, 200, 100, _MAGIC, _AP, 1.5, function() return (player:CanUseSpell(_R) == READY) end)
--~ DLib:RegisterDamageSource(_W, _MAGIC, 25, 45, _MAGIC, _AP, 0.8)
--~ DLib:RegisterDamageSource(_E, _MAGIC, 70, 40, _MAGIC, _AP, 1.0)
--~ DLib:RegisterDamageSource(_R, _MAGIC, 200, 100, _MAGIC, _AP, 1.5)

--~ local MainCombo = {_ITEMS, _W, _E, _R, _IGNITE}
local MainCombo = {_W, _E, _R, _IGNITE, _ITEMS}
...
function Menu()
	...
	DLib:AddToMenu(TristyMenu.draw, MainCombo)
